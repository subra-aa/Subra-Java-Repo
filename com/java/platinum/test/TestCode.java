...
//                    if (somePerson.getAddressList().size() > 0) {
//                        System.out.println(somePerson.getAddressList().get(1).getAddressLineOne());
//                        System.out.println(somePerson.getAddressList().get(1).getAddressLineTwo());
//                        System.out.println(somePerson.getAddressList().get(1).getCity());
//                        System.out.println(somePerson.getAddressList().get(1).getState());
//                        System.out.println(somePerson.getAddressList().get(1).getCountry());
//                    }

                    for (Address enhancedLoopAddress : somePerson.getAddressList()) {
                        System.out.println("#######################################");
                        System.out.println(enhancedLoopAddress.getAddressLineOne());
                        System.out.println(enhancedLoopAddress.getAddressLineTwo());
                        System.out.println(enhancedLoopAddress.getCity());
                        System.out.println(enhancedLoopAddress.getState());
                        System.out.println(enhancedLoopAddress.getCountry());
                        System.out.println("#######################################");
                    }
